  ...
  return (
    ...
    <div className="container">
      ...
      <div className="d-flex mt-3 mb-2">
        <h5 className="ms-2">Democracy Proposals</h5>
      </div>
      <div className="block_box box_margin">
        <div className="d-flex">
        <button className={paraData === "paraChain" ? "select_btn_active select_btn" : "select_btn"} onClick={() => showParaData("paraChain")} >Waiting Queue (7)</button>
        <button className={paraData === "paraThread" ? "select_btn_active select_btn" : "select_btn"} onClick={()=>showParaData("paraThread")}>Historical Proposal(20)</button>
     {/* <div className="ms-auto">
       <button className="ms-auto view mt-3">View All</button> 
       </div> */}
       </div>
