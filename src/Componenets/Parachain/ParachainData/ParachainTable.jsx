  ...
  return (
    <div className="container">
      <div className="d-flex mt-3 mb-2">
        <h5 className="ms-2">Parachain</h5>
      ...
      <div className="block_box box_margin">
        <button className={paraData === "paraChain" ? "select_btn_active select_btn" : "select_btn"} onClick={() => showParaData("paraChain")} >Parachain</button>
        <button className={paraData === "paraThread" ? "select_btn_active select_btn" : "select_btn"} onClick={()=>showParaData("paraThread")}>Parathread</button>
        <button className={paraData === "registered" ? "select_btn_active select_btn" : "select_btn"} onClick={()=>showParaData("registered")}>Registered</button>     
